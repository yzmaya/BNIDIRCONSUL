...
-- ─────────────────────────────────────────
-- CHAPTERS (tabla primero, sin políticas que
-- referencien profiles todavía)
-- ─────────────────────────────────────────
...
-- Lectura para todos los autenticados (dropdown del registro)
create policy "chapters_read" on public.chapters
  for select to authenticated using (true);

-- ─────────────────────────────────────────
-- PROFILES (depende de chapters via FK)
-- ─────────────────────────────────────────
create table public.profiles (
  id                    uuid primary key references auth.users(id) on delete cascade,
  nombre                text not null default '',
  telefono              text not null default '',
  bni_connect_email     text not null default '',
  bni_connect_password  text not null default '',
...
-- ─────────────────────────────────────────
-- POLÍTICA ADMIN EN CHAPTERS
-- (ahora profiles ya existe)
-- ─────────────────────────────────────────
